...
public class Sprite : MonoBehaviour {
	...
	public void SetupUVs(){
		Image2D image2D = GetComponent<Image2D>();

		frameColumns = (int) Mathf.Floor(image2D.areaRect.width / frameWidth);
		frameRows = (int) Mathf.Floor(image2D.areaRect.height / frameHeight);
	...
	void CalculateFrame(){
		Image2D billboard = GetComponent<Image2D>();
