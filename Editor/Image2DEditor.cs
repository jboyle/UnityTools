...
[CustomEditor(typeof(Image2D))]
public class Image2DEditor : Editor {
	...
	override public void OnInspectorGUI(){
		...
		if(billboard.atlas != null){
			...
			//if(billboard.GetComponent<TiledImage>()){
		...
		if(r != billboard.areaRect || ro != billboard.rows || cl != billboard.columns){
			/*if(!billboard.repeatTexture){
				billboard.columns = 1;
				billboard.rows = 1;
			}*/
